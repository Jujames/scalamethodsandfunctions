...
object CurryingIII extends App {
  ...
  /** Changed to a method using curried Functions with 3 argument list */
  ...
  /** To invoke make sure you use 3 parenthesis for each argument */
